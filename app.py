                    ...
                    if st.button("🎯 Generuj ćwiczenie", use_container_width=True, key="generate_exercise_main"):
                        with st.spinner(f"Generuję ćwiczenie z {exercise_type}..."):
                            ...
                            if "error" not in exercise:
                                ...
                                # Utwórz element ćwiczenia dla sesji
                                exercise_item = {
                                    'id': db_id,
                                ...
                                # Ustaw aktualne ćwiczenie
                                st.session_state.current_exercise = exercise_item
                                
                                # Odśwież dane z bazy danych (ale nie nadpisuj current_exercise)
                                reload_data_from_db()
                        ...
                        if st.button("🔄 Nowe ćwiczenie", use_container_width=True, key="new_exercise"):
                            with st.spinner(f"Generuję nowe ćwiczenie z {exercise_type}..."):
                                ...
                                if "error" not in new_exercise:
                                    ...
                                    # Utwórz element nowego ćwiczenia dla sesji
                                    new_exercise_item = {
                                        'id': db_id,
                                        'timestamp': datetime.now(),
                    ...
                    with st.spinner("Przetwarzam..."):
                        if "Tłumaczenie" in mode:
                            ...
                            if result:
                                ...
                                if db_id:
                                    # Utwórz element tłumaczenia dla sesji
                                    translation_item = {
                                        'id': db_id,
                                        'timestamp': datetime.now(),
                                        'input': input_text,
                                    ...
                                    # Odśwież dane z bazy danych (ale nie nadpisuj current_session_action)
                                    reload_data_from_db()
                            ...
                            if corrected:
                                ...
                                if db_id:
                                    # Utwórz element poprawki dla sesji
                                    correction_item = {
                                        'id': db_id,
                                        'timestamp': datetime.now(),
                                        'input': input_text,
                            ...
                            try:
                                ...
                                if analysis:
                                    ...
                                    # Utwórz element analizy dla sesji
                                    analysis_item = {
                                        'id': db_id,
                                        'timestamp': datetime.now(),
                                        'input': input_text,
